<?php
  class Application_Model_DbTable_IngredienteEmpresa extends Zend_Db_Table_Abstract
  {
      ...
      {
          $query = $this->_db->query("SELECT * FROM ingrediente_empresa where cod_ingrediente='$ingredienteId' AND cod_empresa=$empresaId ");
          $result = $query->fetchAll();
          $result = $result[0];
          return $result;
      }
