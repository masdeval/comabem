...
-- Started on 2011-12-04 11:20:04
...
-- Dependencies: 1630
-- Name: categoria_ingrediente_cod_tipo_ingrediente_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('categoria_ingrediente_cod_tipo_ingrediente_seq', 7, true);
...
SELECT pg_catalog.setval('foto_produto_cod_foto_seq', 5, true);
...
SELECT pg_catalog.setval('produto_cod_produto_seq', 2, true);
...
SELECT pg_catalog.setval('promocao_cod_promocao_seq', 5, true);
...
SELECT pg_catalog.setval('tamanho_produto_cod_tamanho_produto_seq', 10, true);
...
SELECT pg_catalog.setval('tipo_produto_cod_tipo_produto_seq', 7, true);


--
-- TOC entry 2140 (class 0 OID 24881)
-- Dependencies: 1631
-- Data for Name: categoria_ingrediente; Type: TABLE DATA; Schema: public; Owner: postgres
--

SET SESSION AUTHORIZATION DEFAULT;

ALTER TABLE categoria_ingrediente DISABLE TRIGGER ALL;

INSERT INTO categoria_ingrediente (cod_tipo_ingrediente, nome) VALUES (1, 'Guarnição');
INSERT INTO categoria_ingrediente (cod_tipo_ingrediente, nome) VALUES (2, 'Molho');
INSERT INTO categoria_ingrediente (cod_tipo_ingrediente, nome) VALUES (3, 'Salada');
INSERT INTO categoria_ingrediente (cod_tipo_ingrediente, nome) VALUES (4, 'Pizza');
INSERT INTO categoria_ingrediente (cod_tipo_ingrediente, nome) VALUES (5, 'Pratos quentes');
INSERT INTO categoria_ingrediente (cod_tipo_ingrediente, nome) VALUES (6, 'Sanduíche');
INSERT INTO categoria_ingrediente (cod_tipo_ingrediente, nome) VALUES (7, 'Geral');


ALTER TABLE categoria_ingrediente ENABLE TRIGGER ALL;

--
-- TOC entry 2113 (class 0 OID 24606)
-- Dependencies: 1590
...
--
-- TOC entry 2116 (class 0 OID 24637)
-- Dependencies: 1596
...
--
-- TOC entry 2117 (class 0 OID 24645)
-- Dependencies: 1598 2116
...
--
-- TOC entry 2123 (class 0 OID 24700)
-- Dependencies: 1607 2113 2117
-- Data for Name: empresa; Type: TABLE DATA; Schema: public; Owner: postgres
--

ALTER TABLE empresa DISABLE TRIGGER ALL;

INSERT INTO empresa (cod_empresa, cod_cidade, razao_social, cnpj, rua, numero, cep, complemento, valor_minimo_entrega, nome_fantasia, logo, telefone1, telefone2, bairro, email, url, removed, desativada, data_cadastro, cod_estrategia_cobranca_pizza) VALUES (4, 2, 'razao_social', '28899989      ', 'rua', 0, 'cep     ', 'complemento', 20.00, 'nome_fantasia', '', 'telefone1 ', 'telefone2 ', 'bairro', 'example@example.com', 'dddd', 0, 0, '2011-02-12 10:05:46', NULL);
INSERT INTO empresa (cod_empresa, cod_cidade, razao_social, cnpj, rua, numero, cep, complemento, valor_minimo_entrega, nome_fantasia, logo, telefone1, telefone2, bairro, email, url, removed, desativada, data_cadastro, cod_estrategia_cobranca_pizza) VALUES (37, 2, 'teste da silva sauro', '78203805191   ', 'rua 7 de setembro', 3456, '79020310', 'apto 1901', 20.00, 'Massas e Dogão Lanches LTDA', '', '          ', '          ', '', 'silvo@hotmail.com', 'coc', 0, 0, '2011-02-24 10:19:27', NULL);


ALTER TABLE empresa ENABLE TRIGGER ALL;

--
-- TOC entry 2118 (class 0 OID 24655)
-- Dependencies: 1600
...
--
-- TOC entry 2130 (class 0 OID 24779)
-- Dependencies: 1618 2118 2123
...
--
-- TOC entry 2142 (class 0 OID 24895)
-- Dependencies: 1633 2130 2140
-- Data for Name: categoria_ingrediente_empresa; Type: TABLE DATA; Schema: public; Owner: postgres
--

ALTER TABLE categoria_ingrediente_empresa DISABLE TRIGGER ALL;

INSERT INTO categoria_ingrediente_empresa (cod_tipo_ingrediente, cod_empresa, cod_ingrediente) VALUES (1, 37, 1);
INSERT INTO categoria_ingrediente_empresa (cod_tipo_ingrediente, cod_empresa, cod_ingrediente) VALUES (4, 37, 2);
INSERT INTO categoria_ingrediente_empresa (cod_tipo_ingrediente, cod_empresa, cod_ingrediente) VALUES (6, 37, 2);
INSERT INTO categoria_ingrediente_empresa (cod_tipo_ingrediente, cod_empresa, cod_ingrediente) VALUES (1, 37, 3);
INSERT INTO categoria_ingrediente_empresa (cod_tipo_ingrediente, cod_empresa, cod_ingrediente) VALUES (7, 37, 4);
INSERT INTO categoria_ingrediente_empresa (cod_tipo_ingrediente, cod_empresa, cod_ingrediente) VALUES (1, 37, 5);
INSERT INTO categoria_ingrediente_empresa (cod_tipo_ingrediente, cod_empresa, cod_ingrediente) VALUES (4, 37, 6);
INSERT INTO categoria_ingrediente_empresa (cod_tipo_ingrediente, cod_empresa, cod_ingrediente) VALUES (6, 37, 6);
INSERT INTO categoria_ingrediente_empresa (cod_tipo_ingrediente, cod_empresa, cod_ingrediente) VALUES (7, 37, 6);


ALTER TABLE categoria_ingrediente_empresa ENABLE TRIGGER ALL;

--
-- TOC entry 2115 (class 0 OID 24625)
-- Dependencies: 1594
...
INSERT INTO tipo_produto (cod_tipo_produto, nome, foto, is_especialidade) VALUES (6, 'Lanches ', NULL, NULL);
...
--
-- TOC entry 2124 (class 0 OID 24718)
-- Dependencies: 1609 2115 2123
-- Data for Name: produto; Type: TABLE DATA; Schema: public; Owner: postgres
--

ALTER TABLE produto DISABLE TRIGGER ALL;

INSERT INTO produto (cod_produto, nome, descricao, tempo_preparo_minutos, valor_calorico, numero_max_adicionais, fator_de_ajuste, cobrado_por_quilo, disponivel, removed, cod_empresa, cod_tipo_produto) VALUES (2, 'Cachorro Quente', 'Duas salsichas sadia, cebola, milho, ervilha, bata frita e molho especial com azeite.', 5, 142, 0, 0, NULL, true, 0, 37, 6);
INSERT INTO produto (cod_produto, nome, descricao, tempo_preparo_minutos, valor_calorico, numero_max_adicionais, fator_de_ajuste, cobrado_por_quilo, disponivel, removed, cod_empresa, cod_tipo_produto) VALUES (1, 'Macarrão Carbonara', 'Deliciosa massa caseira, levemente refogada no azeite, temperada com champignon, azeitonas pretas e bacons selecionados.', 28, 450, 2, 0, NULL, true, 0, 37, 1);


ALTER TABLE produto ENABLE TRIGGER ALL;

--
-- TOC entry 2141 (class 0 OID 24887)
-- Dependencies: 1632 2124 2140
-- Data for Name: categoria_permitida_como_adicional; Type: TABLE DATA; Schema: public; Owner: postgres
--

ALTER TABLE categoria_permitida_como_adicional DISABLE TRIGGER ALL;

INSERT INTO categoria_permitida_como_adicional (cod_produto, cod_tipo_ingrediente, qtd_max_adicionais) VALUES (1, 1, 5);
INSERT INTO categoria_permitida_como_adicional (cod_produto, cod_tipo_ingrediente, qtd_max_adicionais) VALUES (1, 4, 1);


ALTER TABLE categoria_permitida_como_adicional ENABLE TRIGGER ALL;

--
-- TOC entry 2134 (class 0 OID 24824)
-- Dependencies: 1623 2117
...
--
-- TOC entry 2119 (class 0 OID 24667)
-- Dependencies: 1602
...
--
-- TOC entry 2121 (class 0 OID 24684)
-- Dependencies: 1604 2119
...
--
-- TOC entry 2122 (class 0 OID 24692)
-- Dependencies: 1605 2121
...
--
-- TOC entry 2128 (class 0 OID 24761)
-- Dependencies: 1616 2124
...
--
-- TOC entry 2133 (class 0 OID 24813)
-- Dependencies: 1621 2119 2123
...
INSERT INTO funcionario_has_empresa (cod_funcionario, cod_empresa, responsavel) VALUES (3, 37, '0');
...
--
-- TOC entry 2132 (class 0 OID 24806)
-- Dependencies: 1620 2123
...
INSERT INTO horario_funcionamento (cod_empresa, dia_da_semana, hora_inicio, hora_fim) VALUES (11, 'Segunda', '12:12:00', '12:12:00');
INSERT INTO horario_funcionamento (cod_empresa, dia_da_semana, hora_inicio, hora_fim) VALUES (11, 'Terca', '12:12:00', '12:12:00');
INSERT INTO horario_funcionamento (cod_empresa, dia_da_semana, hora_inicio, hora_fim) VALUES (11, 'Quarta', '12:12:00', '12:12:00');
INSERT INTO horario_funcionamento (cod_empresa, dia_da_semana, hora_inicio, hora_fim) VALUES (11, 'Quinta', '12:12:00', '12:12:00');
INSERT INTO horario_funcionamento (cod_empresa, dia_da_semana, hora_inicio, hora_fim) VALUES (11, 'Sexta', '12:12:00', '12:12:00');
INSERT INTO horario_funcionamento (cod_empresa, dia_da_semana, hora_inicio, hora_fim) VALUES (12, 'Segunda', '12:12:00', '12:12:00');
INSERT INTO horario_funcionamento (cod_empresa, dia_da_semana, hora_inicio, hora_fim) VALUES (12, 'Terca', '12:12:00', '12:12:00');
INSERT INTO horario_funcionamento (cod_empresa, dia_da_semana, hora_inicio, hora_fim) VALUES (12, 'Quarta', '12:12:00', '12:12:00');
INSERT INTO horario_funcionamento (cod_empresa, dia_da_semana, hora_inicio, hora_fim) VALUES (16, 'Segunda', '12:12:00', '12:12:00');
INSERT INTO horario_funcionamento (cod_empresa, dia_da_semana, hora_inicio, hora_fim) VALUES (13, 'Segunda', '12:12:00', '12:12:00');
INSERT INTO horario_funcionamento (cod_empresa, dia_da_semana, hora_inicio, hora_fim) VALUES (13, 'Terca', '12:12:00', '12:12:00');
INSERT INTO horario_funcionamento (cod_empresa, dia_da_semana, hora_inicio, hora_fim) VALUES (13, 'Quarta', '12:12:00', '12:12:00');
INSERT INTO horario_funcionamento (cod_empresa, dia_da_semana, hora_inicio, hora_fim) VALUES (13, 'Quinta', '12:12:00', '12:12:00');
INSERT INTO horario_funcionamento (cod_empresa, dia_da_semana, hora_inicio, hora_fim) VALUES (13, 'Sexta', '12:12:00', '12:12:00');
INSERT INTO horario_funcionamento (cod_empresa, dia_da_semana, hora_inicio, hora_fim) VALUES (4, 'Segunda', '07:00:00', '23:00:00');
INSERT INTO horario_funcionamento (cod_empresa, dia_da_semana, hora_inicio, hora_fim) VALUES (4, 'Terca', '07:00:00', '23:00:00');
INSERT INTO horario_funcionamento (cod_empresa, dia_da_semana, hora_inicio, hora_fim) VALUES (4, 'Quarta', '12:00:00', '23:00:00');
INSERT INTO horario_funcionamento (cod_empresa, dia_da_semana, hora_inicio, hora_fim) VALUES (4, 'Quinta', '07:00:00', '23:00:00');
INSERT INTO horario_funcionamento (cod_empresa, dia_da_semana, hora_inicio, hora_fim) VALUES (4, 'Sexta', '07:00:00', '23:00:00');


ALTER TABLE horario_funcionamento ENABLE TRIGGER ALL;

--
-- TOC entry 2131 (class 0 OID 24795)
-- Dependencies: 1619 2124 2130
-- Data for Name: itens_de_um_lanche; Type: TABLE DATA; Schema: public; Owner: postgres
--

ALTER TABLE itens_de_um_lanche DISABLE TRIGGER ALL;



ALTER TABLE itens_de_um_lanche ENABLE TRIGGER ALL;

--
-- TOC entry 2136 (class 0 OID 24842)
-- Dependencies: 1626 2122 2134
...
--
-- TOC entry 2125 (class 0 OID 24731)
-- Dependencies: 1611 2124
...
--
-- TOC entry 2137 (class 0 OID 24854)
-- Dependencies: 1627 2125 2136
...
--
-- TOC entry 2114 (class 0 OID 24617)
-- Dependencies: 1592
...
--
-- TOC entry 2135 (class 0 OID 24835)
-- Dependencies: 1624 2114 2134
...
--
-- TOC entry 2139 (class 0 OID 24871)
-- Dependencies: 1629 2130 2137
...
--
-- TOC entry 2111 (class 0 OID 24590)
-- Dependencies: 1587
...
--
-- TOC entry 2120 (class 0 OID 24679)
-- Dependencies: 1603 2111 2119
...
--
-- TOC entry 2126 (class 0 OID 24740)
-- Dependencies: 1612 2114 2125
...
--
-- TOC entry 2127 (class 0 OID 24747)
-- Dependencies: 1614 2125
-- Data for Name: promocao; Type: TABLE DATA; Schema: public; Owner: postgres
--

ALTER TABLE promocao DISABLE TRIGGER ALL;

INSERT INTO promocao (cod_promocao, cod_produto, data_inicio, data_fim, preco_promocional, anuncio, removed, cod_tamanho_produto) VALUES (1, 1, '2011-04-01 00:00:00', '2011-04-28 00:00:00', 15.90, 'coco gg', 1, 5);
INSERT INTO promocao (cod_promocao, cod_produto, data_inicio, data_fim, preco_promocional, anuncio, removed, cod_tamanho_produto) VALUES (2, 1, '2011-04-20 00:00:00', '2011-05-26 00:00:00', 67.00, '', 1, 5);
INSERT INTO promocao (cod_promocao, cod_produto, data_inicio, data_fim, preco_promocional, anuncio, removed, cod_tamanho_produto) VALUES (4, 1, '2011-04-20 00:00:00', '2011-04-28 00:00:00', 56.00, '', 1, 5);
INSERT INTO promocao (cod_promocao, cod_produto, data_inicio, data_fim, preco_promocional, anuncio, removed, cod_tamanho_produto) VALUES (5, 1, '2011-04-27 00:00:00', '2011-04-30 00:00:00', 67.00, '', 1, 6);
INSERT INTO promocao (cod_promocao, cod_produto, data_inicio, data_fim, preco_promocional, anuncio, removed, cod_tamanho_produto) VALUES (3, 1, '2011-04-01 00:00:00', '2011-04-21 00:00:00', 67.00, '', 1, 6);


ALTER TABLE promocao ENABLE TRIGGER ALL;

--
-- TOC entry 2110 (class 0 OID 24579)
-- Dependencies: 1585
...
--
-- TOC entry 2112 (class 0 OID 24599)
-- Dependencies: 1588 2110 2111
...
--
-- TOC entry 2138 (class 0 OID 24863)
-- Dependencies: 1628 2124 2137
...
--
-- TOC entry 2129 (class 0 OID 24772)
-- Dependencies: 1617 2115 2123
...
INSERT INTO tipos_produtos_empresa (cod_tipo_produto, cod_empresa) VALUES (1, 4);
INSERT INTO tipos_produtos_empresa (cod_tipo_produto, cod_empresa) VALUES (2, 4);
...
-- Completed on 2011-12-04 11:20:08
